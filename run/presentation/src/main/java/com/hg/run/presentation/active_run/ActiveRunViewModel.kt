...
import com.hg.core.presentation.ui.asUiText
import com.hg.run.domain.LocationDataCalculator
...
class ActiveRunViewModel(
    ...
    init {
        watchConnector.connectedDevice.filterNotNull()
            .onEach {
                Timber.d("New device: ${it.displayName}")
